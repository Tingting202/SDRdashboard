    ...
    def set_INT(param, i, j, subcounty, f_intvs, i_scenarios, sc, comps, global_vars):
        ...
        if subcounty[j] == 1:
            ...
            if flag_int2:
                ...
                INT['int2']['coverage'][j] = min(int_knowl * int_suppl * i_usage[1], 1)  # quality_factor
            ...
            if flag_int5:
                ...
                INT['int5']['coverage'][j] = min(int_knowl * int_suppl * i_usage[2], 1)  # quality_factor
            ...
            if flag_int6:
                ...
                INT['int6']['coverage'][j] = min(int_knowl * int_suppl * i_usage[3], 1)  # quality_factor
        ...
        for i in t:
            ...
            for j in range(sc_time['n']):
                ...
                if i > 0:
                    ...
                    df_3d.loc[(j, i), 'Facility capacity'] = Capacity[j]
